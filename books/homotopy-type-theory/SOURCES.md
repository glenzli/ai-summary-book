...
本书不是泛泛综述。每个核心定义、定理和证明路线都应能追溯到正式数学资料、教材、论文或经典文献。基础类型论、单值性、simplicial/cubical 语义与 HIT 条目于 2026-07-11 重新核查；其余近期研究条目沿用 2026-06-29 至 2026-06-30 的核查记录。后续扩写必须重新核查可能变化的版本信息。
...
1.  The Univalent Foundations Program, *Homotopy Type Theory: Univalent Foundations of Mathematics*, Institute for Advanced Study, 2013, <https://homotopytypetheory.org/book/>.
    用途：第 1-2 章的 universe/family 与 identity/transport 规则定位到 §§1.3、1.12、2.3 和 Appendix A；函数外延性与单值性定位到 §§2.9-2.10、4.9；圆及其 induction/computation 定位到 Chapter 6。第 6 章定理 6.11 精确使用 Theorems 4.9.4-4.9.5。
