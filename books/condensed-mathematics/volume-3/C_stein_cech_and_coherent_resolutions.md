...
Stein/Cartan 工具的更细版本，包括紧集附近有限全局生成、Stein acyclic 覆盖和短正合列全局截面正合性，见附录 V。相干层有限局部自由分解的正则局部环证明链见附录 W。

Cartan A/B 本身的证明模块，包括 Oka coherence、Cousin 消没和 jet lifting 的依赖关系，见附录 AB。
