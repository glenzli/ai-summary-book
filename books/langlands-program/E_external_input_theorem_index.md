...
- `GL(2)` principal series、Steinberg、supercuspidal classification、admissible pairs 和 conductor/newvector theory：第五、十二、十四章、附录 AE；参考 Jacquet-Langlands、Gelbart、Bushnell-Henniart、Casselman。
