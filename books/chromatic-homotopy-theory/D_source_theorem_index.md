...
| CHT-P0-14 | Morava descent spectral sequence | 第六章计算接口 | batch 2 bibliographic locator |
| CHT-P0-15 | BHLŠ telescope counterexample | 第七章新版 telescope 口径 | frontier locator |
| CHT-P0-16 | Hahn-Wilson multiplication/redshift | 第七章 redshift 输入 | frontier locator |
| CHT-P0-17 | Chromatic Nullstellensatz | 第七章 redshift/nilpotence detection | frontier locator |
| CHT-P0-18 | Cyclotomic redshift/descent | 第七章 cyclotomic 接口 | frontier locator |
| CHT-P0-19 | Elliptic curve formal group height | 第八章 ordinary/supersingular | batch 2 bibliographic locator |
| CHT-P0-20 | tmf sheaf construction | 第八章 tmf 外部构造 | batch 2 bibliographic locator |

## D.2 P1 外部输入

| 编号 | 定理包 | 当前用途 | 状态 |
| --- | --- | --- | --- |
| CHT-P1-01 | Hopkins-Lurie/CSY higher semiadditivity | 第七章边界，后续第九章 | 待扩写 |
| CHT-P1-02 | Transchromatic character theory | 后续第九章 | 待扩写 |
| CHT-P1-03 | Rational $K(n)$-local sphere computation | 后续 chromatic splitting 章 | 待扩写 |
| CHT-P1-04 | Gross-Hopkins duality | 后续 duality 章 | 待扩写 |
| CHT-P1-05 | $K(n)$-local Picard group results | 后续 Picard 章 | 待扩写 |
| CHT-P1-06 | Equivariant chromatic periodicity | 后续 equivariant 章 | 待扩写 |
| CHT-P1-07 | Motivic Morava E-theory automorphisms | 后续 motivic 章 | 待扩写 |
| CHT-P1-08 | Angelini-Knoll 2026 syntomic/K-theory of $BP\langle n\rangle$ | 第七章前沿记录 | frontier locator, not proof-chain |
| CHT-P1-09 | Hopkins-Lurie/CSY higher semiadditivity | 第九章 | frontier locator |
| CHT-P1-10 | Hopkins-Kuhn-Ravenel character theory | 第九章 | batch 2 bibliographic locator |
| CHT-P1-11 | Ben-Moshe transchromatic semiadditivity | 第九章 | frontier locator |
| CHT-P1-12 | Gross-Hopkins duality | 第十章 | batch 2 bibliographic locator |
| CHT-P1-13 | Hopkins-Mahowald-Sadofsky/Hovey-Sadofsky Picard group | 第十章 | batch 2 bibliographic locator |
| CHT-P1-14 | Picard/Brauer profinite Galois descent | 第十章 | batch 2 bibliographic locator |
...
1. 使用哪个编号，例如 CHT-P0-06；
2. 调用的是定理结论、定义约定还是证明技术；
3. 当前对象是否满足定理假设；
4. 若定理只在特定模型中陈述，是否已经翻译到本书稳定 infinity-范畴口径。

## D.4 当前禁止事项

- 未完成 CHT-P0-15 前，不得写“telescope conjecture 已被完全解决”这种无范围表述；只能写本书已核查的高度至少 $2$ 差异结论。
- 未完成 CHT-P0-16/17 前，不得把 redshift 写成任意 ring spectrum 的无条件定理。
- 未完成 CHT-P0-12/13 前，不得把 $E_n^{hG_n}$ 公式用于任意谱。
- 未完成 CHT-P1-08 前，Angelini-Knoll 2026 只能作前沿记录。
