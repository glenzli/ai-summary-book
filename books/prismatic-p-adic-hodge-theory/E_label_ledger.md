...
本附录登记当前正式教材扩展稿中的稳定章节与声明编号。它不新增数学定理。最终版本应把所有散文引用替换为本账本中的编号。
...
| `07_nygaard_syntomic_and_tate_twists.md` | 定义 7.1 - 练习 7.3 | 已登记 |
| `08_prismatization_f_gauges_and_frontier.md` | 说明 8.1 - 练习 8.3 | 已登记 |
...
| `J_linear_algebra_of_periods_and_lattices.md` | 定义 J.1 - 练习 J.3 | 已登记 |
| `K_worked_examples_and_local_models.md` | 例 K.1 - 练习 K.3 | 已登记 |
| `SOLUTIONS.md` | 全部章末练习解答 | 已登记 |
| `TERM_INDEX.md` | 术语索引 | 已登记 |
| `INTERNAL_COMPLETENESS_AUDIT.md` | 内部完整性审计 | 已登记 |
...
1. 新增正式声明时，不复用已登记编号。
2. 删除声明时，在账本中标为 retired，而不是静默移除。
3. 散文引用必须逐步替换为“定义 2.3”“定理 11.8”这类编号。
4. 章节重排时，先更新本账本，再改正文引用。

## 本附录小结

当前账本已覆盖正式教材扩展稿的全部章节和附录。它还不是最终交叉引用系统，但足以支撑下一轮编号校对。
