...
1. Classical worldsheet geometry：第 1、2 章。
2. Worldsheet CFT：第 3、5 章和附录 B。
3. Bosonic spectrum：第 4、5、6 章。
...
| 外部输入 | 使用位置 | 展开策略 |
|---|---|---|
| Riemann surface moduli | 第 5、15 章 | 接口陈述 |
