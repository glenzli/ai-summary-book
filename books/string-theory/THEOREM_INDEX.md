...
| 编号 | 状态 | 内容 | 依赖 |
|---|---|---|---|
| 1.1 | P | Euler-Lagrange 方程 | 变分法 |
| 1.4 | P | sigma model stress tensor | metric variation |
...
| 5.12 | E | Polyakov path integral 的 moduli 分解 | Riemann surface theory |
| 5.15 | P | critical bosonic torus integrand | torus partition function |
...
| 9.3 | S | R-R potentials 的次数 parity | Clifford algebra |
| 9.5 | S | type II massless bosons | RNS sectors |
| 9.6B | S | type II massless degrees of freedom matching | little group |
| 9.9 | E | Green-Schwarz action 的 kappa symmetry | GS formalism |
| 9.10 | S | GS light-cone 自由度匹配 | gauge fixing |
| 9.11A | S | light-cone GS spectrum 的基态 | transverse Clifford algebra |
| 9.13 | S | BPS bound 的接口 | supersymmetry algebra |
| 10.2 | P | heterotic central charge accounting | left/right CFT |
| 10.4 | E | 十六维 even unimodular lattices | lattice theory |
| 10.6 | S | heterotic level matching | Virasoro zero modes |
| 10.7 | S | heterotic gauge bosons | current algebra |
...
| 12.9 | S | D3-brane 低能极限为 $\mathcal N=4$ SYM | open superstring spectrum |
...
| 14.10 | C | U-duality | nonperturbative compactification |
| 14.13 | S | duality 检验原则 | protected quantities |
| 14.14 | S | M2 wrapped on circle gives F1 tension | M/IIA dictionary |
| 14.15 | S | D3-brane 的 S-duality 自洽性 | IIB S-duality |
| 15.2 | S | moduli dimension $\dim_\mathbb C\mathcal M_{g,n}$ | Riemann-Roch |
| 15.4 | S | 高 genus 振幅结构 | FP ghosts |
| 15.7 | E | torus modular invariance | mapping class group |
| 15.8 | S | degeneration 与 factorization | CFT sewing |
| 15.12 | S | compact boson torus lattice sum | momentum/winding sectors |
| 15.13 | P | modular $T$ 与 level matching | torus trace |
| 16.2 | P | $Q$-exact stress tensor 给出 topological invariance | BRST argument |
| 16.4 | S | A-model localization | topological sigma model |
| 16.7 | S | B-model dependence | topological twist |
| 16.9 | C | mirror symmetry | topological string duality |
| 16.10 | S | mirror map 的计算意义 | special geometry |
| 16.15 | E | quintic mirror theorem 接口 | mirror theorem |
