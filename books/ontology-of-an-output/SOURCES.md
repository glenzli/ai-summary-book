...
- 本仓库 [《概率的边界》第三章](../probability-boundaries/03_independence_and_products.md) 给出 Ionescu--Tulcea 定理的同口径完整陈述；[第八章](../probability-boundaries/08_randomized_algorithms.md) 给出标准 Borel 随机化引理和实现映射口径。
