...
*   **[DeepSeek-AI, 2024]** *DeepSeek-V3 Technical Report*. (MLA、MoE 与高效训练)
*   **[DeepSeek-AI, 2025]** *DeepSeek-R1: Incentivizing Reasoning Capability in LLMs via Reinforcement Learning*. (推理模型与 RL 后训练)
*   **[OpenAI, 2024]** *Learning to Reason with LLMs*. (o1 与测试时计算)
*   **[Dubey et al., 2024]** *The Llama 3 Herd of Models*. (开放权重模型与长上下文)
*   **[OpenAI, 2026]** *Models Documentation*. (GPT-5.5 / GPT-5.6 preview 等模型族)
*   **[DeepSeek, 2026]** *DeepSeek API Models*. (`deepseek-v4-pro` / `deepseek-v4-flash`)
...
*   **[Google, 2026]** *Gemini API Model Documentation*. (Gemini 3.x / Gemini 3.5 Flash 等模型族)
