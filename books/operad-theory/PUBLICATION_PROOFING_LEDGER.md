...
| `P0_REFERENCE_LOCATORS_BATCH_3.md` | Ayala--Francis AF-0--AF-4 | 支撑第二十章和附录 N/V 的 topological manifold factorization homology 基础版本 |
| `P0_REFERENCE_LOCATORS_BATCH_4.md` | Ginzburg--Kapranov GK-1--GK-7 | 支撑第八、九、十章和附录 I/Q/L 的 classical quadratic Koszul duality core；不完全支撑现代 bar-cobar/cofibrant resolution |
...
| `P0_REFERENCE_LOCATORS_BATCH_9.md` | Pavlov--Scholbach PSAR-1--PSAR-6；PSP-1--PSP-2；Lurie HA-ALG-1--HA-ALG-3 | 支撑第十四、十九章和附录 G/M/R/X 的 modern colored admissibility、rectification、strict-to-infinity algebra comparison；不支撑任意无假设 rectification |
| `P0_REFERENCE_LOCATORS_BATCH_10.md` | Hinich DKR-1--DKR-7；Heuts--Hinich--Moerdijk HHM-1--HHM-5；Lurie HA-OP-1--HA-OP-3；Pratali PRA-1--PRA-5 | 支撑第十八、十九章和附录 M/Z 的 Dwyer--Kan localization、underlying infinity-category、dendroidal-Lurie comparison、category of operators 和 operadic straightening 边界 |
...
| 等级 | 包 | 剩余动作 |
| --- | --- | --- |
| CT | Koszul/bar-cobar convention package | Ginzburg--Kapranov 和 Fresse/Hinich locator 已支撑核心证明；Loday--Vallette/Fresse 书本紧凑表述只需 production 级 convention crosswalk |
...
主要 P0/P1 locator 已收口到批次文件，剩余项目已经由 [FINAL_OPERAD_THEORY_CLOSURE.md](FINAL_OPERAD_THEORY_CLOSURE.md) 分类为 convention package、hypothesis translation、geometry boundary 或 production work。下一步若继续，只做 bibliography 统一、假设翻译表、符号模型核对和排版终校，不再继续寻找主题名 locator 或横向扩写。
