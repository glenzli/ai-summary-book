...
| 第一章 | 对称序列、代入乘积、operad | 已由有限集分块证明 | 无大型外部输入 | 通过 |
...
| B9 | 核心附录稳定 label 表 | 登记附录 A/B/H/K/P/U/X 的 104 个正式编号项 | 已封口 |
| B10 | 散文交叉引用第一轮替换 | 将可直接定位的主体和核心附录散文指称替换为编号引用 | 已封口 |
| B11 | 第八至第二十一章稳定 label 表 | 登记高级章节的 413 个正式编号项 | 已封口 |
| B12 | 剩余附录稳定 label 表 | 登记附录 C/D/E/F/G/I/J/L/M/N/O/Q/R/S/T/V/W/Y/Z 的 395 个正式编号项 | 已封口 |
