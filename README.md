...
<p align="center">
  <img src="assets/dr-stochastic-parrot.png" alt="Dr. Stochastic Parrot" width="320">
</p>
...
- [凝聚数学讲义](books/condensed-mathematics/)：一部中文严格数学教材草稿，从站点、sheaf、紧 Hausdorff 空间与 profinite 空间开始，逐步进入凝聚集合、凝聚阿贝尔群、solid 对象和 analytic rings。
- [凝聚数学讲义：第二卷](books/condensed-mathematics-volume-2/)：接续第一卷，完整起草 solid 派生范畴、solid 环与模、analytic rings、liquid 向量空间、相干对偶和复几何应用的范畴语言。
...
- [Condensed Mathematics Lectures](books/condensed-mathematics/): a rigorous Chinese textbook draft starting from sites, sheaves, compact Hausdorff spaces, and profinite spaces, toward condensed sets, condensed abelian groups, solid objects, and analytic rings.
- [Condensed Mathematics Lectures: Volume II](books/condensed-mathematics-volume-2/): a continuation drafting solid derived categories, solid rings and modules, analytic rings, liquid vector spaces, coherent duality, and the categorical language for complex geometry.
