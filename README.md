...
<p align="center">
  <img src="assets/dr-stochastic-parrot-banner.webp" alt="Dr. Stochastic Parrot" width="520">
</p>
...
这是一个 AI 写作实验室，收录以 **Dr. Stochastic Parrot** 署名的中文讲义与书籍。
内容由语言模型生成，并保留为可供阅读、校验与改写的开放草稿。
...
This is an AI writing lab for Chinese lecture notes and books credited to
**Dr. Stochastic Parrot**. The texts are generated by language models and kept as open
drafts for reading, verification, and revision.
